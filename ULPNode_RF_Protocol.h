...
#define RF_DAT_LOW_BAT      0x40 // 40 to 43 = Low Battery flag (0x43 is reserved for Always Enabled DC Booster)
...
#define ULPN_CONFIG_TYPE_RF95  95 /* Type for RFM95 */
...
#define SENSOR_NOT_A_TEMP -9999 /* -99.99°C */
typedef struct
{
  uint8_t code; // code
...
#define SENSOR_NOT_A_HUM 1111 /* 111.1 %RH */
typedef struct
{
  uint8_t code;  // code
...
#define SENSOR_NOT_A_LUX 65535 /* 6553.5 LUX */
typedef struct
{
  uint8_t code;  // code
...
#define SENSOR_NOT_A_CO2 55555 /* 55555 PPM */
typedef struct
{
  uint8_t code;  // code
...
#define SENSOR_NOT_A_BAT 9999 /* 9.999 Volt */
typedef struct
{
  uint8_t code;  // code
